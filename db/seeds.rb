...
friend1 = Friend.create(name: 'Reginald Amedee',status: "online", user: user)
friend2 = Friend.create(name: 'Joseph Parker',status: "online", user: user)
friend3 = Friend.create(name: 'Adeel Ahmad',status: "offline", user: user)
