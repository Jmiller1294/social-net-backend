...
post1 = Post.create(content: 'This is my first post', user: user)
post2 = Post.create(content: 'Today was a good day', user: user)
post3 = Post.create(content: 'Im working on my final project for the flatiron school!', user: user)
...
post1 = Post.create(content: 'What a great day', user: user2)
